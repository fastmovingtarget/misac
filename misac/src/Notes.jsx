...
function Notes(volume) {
    ...
    const playHooks = {
        ...
        "a\u266d1":useSound(g1s, {volume:volume})[0],
        ...
        "a\u266d2":useSound(g2s, {volume:volume})[0],
        ...
        "a\u266d3":useSound(g3s, {volume:volume})[0],
        ...
        "a\u266d4":useSound(g4s, {volume:volume})[0],
        ...
        "a\u266d5":useSound(g5s, {volume:volume})[0],
        ...
        "a\u266d6":useSound(g6s, {volume:volume})[0],
        ...
        "a\u266d7":useSound(g7s, {volume:volume})[0],
